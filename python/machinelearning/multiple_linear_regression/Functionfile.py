...
def visualize_result(X_train1, X_test1, Y_train1, Y_test1, lin_regressor):
    plt.scatter(X_train1, Y_train1, color = 'blue')
    
    X_test2 = np.reshape(X_test1, (-1,1))
    plt.plot(X_test2, lin_regressor.predict(X_test2), color='red')
